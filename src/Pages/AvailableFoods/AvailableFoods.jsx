...
const AvailableFoods = () => {
    ...
    return (
        <div className='min-h-screen px-5 xl:px-0 max-w-[1140px] mx-auto mb-[148px]'>
            ...
            <div className='text-center bg-[#f3f7fc] shadow-lg w-full h-fit md:h-[200px] flex flex-col items-center justify-center rounded-[16px] mt-[30px] py-6 md:py-0'>
                <h1 className="text-[#575d90] text-[40px] font-bold">Search for Food</h1>
                <div className='flex flex-col gap-y-2 md:flex-row shadow-md w-full md:w-1/2 h-fit'>
                    <div className='w-full md:w-[150px] p-5 md:p-0'>
                        <select onChange={handleSort} ref={sortRef} className="select bg-white md:rounded-r-none w-full border-none focus:outline-none">
                    ...
                    <hr />
                    <div className='flex px-5 md:px-0 w-full'>
                        <input ref={searchRef} name='name' type="text" placeholder="Name" className="input input-bordered bg-white rounded-xl border-none w-full md:rounded-none focus:outline-none" required
                        />
                    </div>
                    <button onClick={handleSearch} className='btn btn-primary md:rounded-l-none w-[90%] md:w-fit mx-auto'>Search</button>
                </div>
            </div>
